...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i17.MyProfileInfoBloc>(
        () => _i17.MyProfileInfoBloc(gh<_i16.IAuthFacade>()));
    gh.factory<_i18.GetAllUsersBloc>(
        () => _i18.GetAllUsersBloc(gh<_i16.IAuthFacade>()));
    gh.factory<_i19.UpdateStatusUserBloc>(
        () => _i19.UpdateStatusUserBloc(gh<_i16.IAuthFacade>()));
    gh.factory<_i20.SubscribeBloc>(
        () => _i20.SubscribeBloc(gh<_i16.IAuthFacade>()));
    gh.factory<_i21.UserDetailBloc>(
        () => _i21.UserDetailBloc(gh<_i16.IAuthFacade>()));
    gh.lazySingleton<_i22.IAdvartRepository>(
        () => _i23.FirebaseCreateAdvartRepository(
              gh<_i3.FirebaseAuth>(),
              gh<_i4.FirebaseFirestore>(),
              gh<_i5.FirebaseStorage>(),
            ));
    gh.lazySingleton<_i24.IChatGroupRepository>(
        () => _i25.FirebaseChatGroupFacade(
              gh<_i3.FirebaseAuth>(),
              gh<_i4.FirebaseFirestore>(),
              gh<_i5.FirebaseStorage>(),
            ));
    gh.lazySingleton<_i26.IChatRepository>(() => _i27.FirebaseChatFacade(
          gh<_i3.FirebaseAuth>(),
          gh<_i4.FirebaseFirestore>(),
          gh<_i5.FirebaseStorage>(),
        ));
    gh.factory<_i28.SendMessageGroupBloc>(() => _i28.SendMessageGroupBloc(
          gh<_i24.IChatGroupRepository>(),
          gh<_i16.IAuthFacade>(),
        ));
    gh.factory<_i29.GetGroupBloc>(() => _i29.GetGroupBloc(
          gh<_i24.IChatGroupRepository>(),
          gh<_i16.IAuthFacade>(),
        ));
    gh.factory<_i30.GetAllAdminsChatGroupBloc>(
        () => _i30.GetAllAdminsChatGroupBloc(
              gh<_i24.IChatGroupRepository>(),
              gh<_i16.IAuthFacade>(),
            ));
    ...
    gh.factory<_i36.GetAllChatGroupBloc>(
        () => _i36.GetAllChatGroupBloc(gh<_i24.IChatGroupRepository>()));
    gh.factory<_i37.RemoveAdminChatGroupBloc>(
        () => _i37.RemoveAdminChatGroupBloc(gh<_i24.IChatGroupRepository>()));
    gh.factory<_i38.UpdateChatGroupBloc>(
        () => _i38.UpdateChatGroupBloc(gh<_i24.IChatGroupRepository>()));
    gh.factory<_i39.CreateChatGroupBloc>(
        () => _i39.CreateChatGroupBloc(gh<_i24.IChatGroupRepository>()));
    gh.factory<_i40.InviteUsersChatGroupBloc>(
        () => _i40.InviteUsersChatGroupBloc(gh<_i24.IChatGroupRepository>()));
    gh.factory<_i41.UpdateManagerChatGroupBloc>(
        () => _i41.UpdateManagerChatGroupBloc(gh<_i24.IChatGroupRepository>()));
    gh.factory<_i42.GetAllGroupMessagesBloc>(
        () => _i42.GetAllGroupMessagesBloc(gh<_i24.IChatGroupRepository>()));
    ...
    gh.lazySingleton<_i52.AddQuestionRepository>(
        () => _i53.FirestoreAddQuestionRepository(
              gh<_i13.IAuthFacade>(),
              firestore: gh<_i4.FirebaseFirestore>(),
              auth: gh<_i3.FirebaseAuth>(),
            ));
    gh.lazySingleton<_i54.ICommunityRepository>(
        () => _i55.FirestoreCommunityRepository(
              gh<_i4.FirebaseFirestore>(),
              gh<_i3.FirebaseAuth>(),
              gh<_i5.FirebaseStorage>(),
            ));
    gh.factory<_i56.AddQuestionBloc>(() => _i56.AddQuestionBloc(
          gh<_i52.AddQuestionRepository>(),
          gh<_i16.IAuthFacade>(),
        ));
    gh.factory<_i57.RegisterWithEmailUC>(
        () => _i57.RegisterWithEmailUC(repository: gh<_i13.IAuthFacade>()));
    gh.factory<_i58.LoginWithEmailUC>(
        () => _i58.LoginWithEmailUC(repository: gh<_i13.IAuthFacade>()));
    gh.lazySingleton<_i59.IProfileInfoRepository>(
        () => _i60.FirebaseProfileFacade(
              gh<_i4.FirebaseFirestore>(),
              gh<_i3.FirebaseAuth>(),
              gh<_i5.FirebaseStorage>(),
            ));
    gh.factory<_i61.CommunityDetailBloc>(
        () => _i61.CommunityDetailBloc(gh<_i54.ICommunityRepository>()));
    gh.factory<_i62.UpdateCommunityBloc>(
        () => _i62.UpdateCommunityBloc(gh<_i54.ICommunityRepository>()));
    gh.factory<_i63.SubscribeCommunityBloc>(
        () => _i63.SubscribeCommunityBloc(gh<_i54.ICommunityRepository>()));
    gh.factory<_i64.CommunityPostListBloc>(
        () => _i64.CommunityPostListBloc(gh<_i33.ICommunityPostRepository>()));
    gh.factory<_i65.ProfileInfoUpdateBloc>(() => _i65.ProfileInfoUpdateBloc(
          gh<_i59.IProfileInfoRepository>(),
          gh<_i13.IAuthFacade>(),
        ));
    gh.factory<_i66.CommunityListBloc>(
        () => _i66.CommunityListBloc(gh<_i54.ICommunityRepository>()));
    gh.factory<_i67.GetAllChatsUseCase>(
        () => _i67.GetAllChatsUseCase(gh<_i26.IChatRepository>()));
    gh.factory<_i68.GetMessagesBloc>(
        () => _i68.GetMessagesBloc(gh<_i26.IChatRepository>()));
    gh.factory<_i69.GetAllChatsBloc>(
        () => _i69.GetAllChatsBloc(gh<_i26.IChatRepository>()));
    gh.factory<_i70.SeenMessageBloc>(
        () => _i70.SeenMessageBloc(gh<_i26.IChatRepository>()));
    ...
    gh.factory<_i73.MyCommunityListBloc>(() => _i73.MyCommunityListBloc(
          gh<_i54.ICommunityRepository>(),
          gh<_i16.IAuthFacade>(),
        ));
    gh.factory<_i74.PostUserListBloc>(
        () => _i74.PostUserListBloc(gh<_i31.IPostRepository>()));
    ...
    gh.factory<_i79.CommunityCommentListBloc>(() =>
        _i79.CommunityCommentListBloc(gh<_i50.ICommunityCommentRepository>()));
    gh.factory<_i80.CommunityCommentLikesBloc>(() =>
        _i80.CommunityCommentLikesBloc(gh<_i50.ICommunityCommentRepository>()));
    gh.factory<_i81.CreateChatroomBloc>(() => _i81.CreateChatroomBloc(
          gh<_i26.IChatRepository>(),
          gh<_i68.GetMessagesBloc>(),
        ));
    gh.factory<_i82.ReplyCommentListBloc>(
        () => _i82.ReplyCommentListBloc(gh<_i43.ICommentRepository>()));
    gh.factory<_i83.CommentLikesBloc>(
        () => _i83.CommentLikesBloc(gh<_i43.ICommentRepository>()));
    gh.factory<_i84.CommentListBloc>(
        () => _i84.CommentListBloc(gh<_i43.ICommentRepository>()));
    ...
    gh.factory<_i86.GetAllQuestionBloc>(
        () => _i86.GetAllQuestionBloc(gh<_i45.IQuestionRepository>()));
