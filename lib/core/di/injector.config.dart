...
import 'package:w_sharme_beauty/features/question/presentation/bloc/add_question_bloc/question_bloc.dart'
    as _i8;
import 'package:w_sharme_beauty/firebase_module.dart' as _i72;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i31.AuthBloc>(() => _i31.AuthBloc(gh<_i15.IAuthFacade>()));
    gh.factory<_i32.GetAllChatGroupBloc>(
        () => _i32.GetAllChatGroupBloc(gh<_i20.IChatGroupRepository>()));
    gh.factory<_i33.CreateChatGroupBloc>(
        () => _i33.CreateChatGroupBloc(gh<_i20.IChatGroupRepository>()));
    gh.factory<_i34.GetAllGroupMessagesBloc>(
        () => _i34.GetAllGroupMessagesBloc(gh<_i20.IChatGroupRepository>()));
    gh.factory<_i35.UpdateChatGroupBloc>(
        () => _i35.UpdateChatGroupBloc(gh<_i20.IChatGroupRepository>()));
    gh.factory<_i36.UpdateManagerChatGroupBloc>(
        () => _i36.UpdateManagerChatGroupBloc(gh<_i20.IChatGroupRepository>()));
    gh.lazySingleton<_i37.ICommentRepository>(() => _i38.FirebaseCommentFacade(
          gh<_i4.FirebaseFirestore>(),
          gh<_i3.FirebaseAuth>(),
        ));
    gh.factory<_i39.CommunityPostListBloc>(() => _i39.CommunityPostListBloc(
          gh<_i29.ICommunityPostRepository>(),
          gh<_i15.IAuthFacade>(),
        ));
    gh.factory<_i40.PostCreateBloc>(() => _i40.PostCreateBloc(
          gh<_i41.IPostRepository>(),
          gh<_i15.IAuthFacade>(),
        ));
    gh.factory<_i42.CommunityCreatePostBloc>(() => _i42.CommunityCreatePostBloc(
          gh<_i29.ICommunityPostRepository>(),
          gh<_i15.IAuthFacade>(),
        ));
    gh.lazySingleton<_i43.ICommunityRepository>(
        () => _i44.FirestoreCommunityRepository(
              gh<_i4.FirebaseFirestore>(),
              gh<_i3.FirebaseAuth>(),
              gh<_i5.FirebaseStorage>(),
            ));
    gh.factory<_i45.RegisterWithEmailUC>(
        () => _i45.RegisterWithEmailUC(repository: gh<_i12.IAuthFacade>()));
    gh.factory<_i46.LoginWithEmailUC>(
        () => _i46.LoginWithEmailUC(repository: gh<_i12.IAuthFacade>()));
    gh.lazySingleton<_i47.IProfileInfoRepository>(
        () => _i48.FirebaseProfileFacade(
              gh<_i4.FirebaseFirestore>(),
              gh<_i3.FirebaseAuth>(),
              gh<_i5.FirebaseStorage>(),
            ));
    gh.factory<_i49.CommunityDetailBloc>(
        () => _i49.CommunityDetailBloc(gh<_i43.ICommunityRepository>()));
    gh.factory<_i50.ProfileInfoUpdateBloc>(() => _i50.ProfileInfoUpdateBloc(
          gh<_i47.IProfileInfoRepository>(),
          gh<_i12.IAuthFacade>(),
        ));
    gh.factory<_i51.CommunityListBloc>(
        () => _i51.CommunityListBloc(gh<_i43.ICommunityRepository>()));
    gh.factory<_i52.GetAllChatsUseCase>(
        () => _i52.GetAllChatsUseCase(gh<_i22.IChatRepository>()));
    gh.factory<_i53.GetMessagesBloc>(
        () => _i53.GetMessagesBloc(gh<_i22.IChatRepository>()));
    gh.factory<_i54.GetAllChatsBloc>(
        () => _i54.GetAllChatsBloc(gh<_i22.IChatRepository>()));
    gh.factory<_i55.SeenMessageBloc>(
        () => _i55.SeenMessageBloc(gh<_i22.IChatRepository>()));
    gh.factory<_i56.CommunityProfileInfoBloc>(
        () => _i56.CommunityProfileInfoBloc(
              gh<_i15.IAuthFacade>(),
              gh<_i47.IProfileInfoRepository>(),
            ));
    gh.factory<_i57.PostLikeBloc>(() => _i57.PostLikeBloc(
          gh<_i41.IPostRepository>(),
          gh<_i12.IAuthFacade>(),
        ));
    gh.factory<_i58.MyCommunityListBloc>(() => _i58.MyCommunityListBloc(
          gh<_i43.ICommunityRepository>(),
          gh<_i15.IAuthFacade>(),
        ));
    gh.factory<_i59.GetGroupBloc>(() => _i59.GetGroupBloc(
          gh<_i20.IChatGroupRepository>(),
          gh<_i15.IAuthFacade>(),
          gh<_i11.ChatGroupCheckManagerBloc>(),
        ));
    gh.factory<_i60.PostUserListBloc>(
        () => _i60.PostUserListBloc(gh<_i25.IPostRepository>()));
    gh.factory<_i61.PostDetailBloc>(() => _i61.PostDetailBloc(
          gh<_i41.IPostRepository>(),
          gh<_i15.IAuthFacade>(),
        ));
    gh.factory<_i62.MyPostListBloc>(() => _i62.MyPostListBloc(
          gh<_i41.IPostRepository>(),
          gh<_i15.IAuthFacade>(),
        ));
    gh.factory<_i63.CreateChatroomBloc>(() => _i63.CreateChatroomBloc(
          gh<_i22.IChatRepository>(),
          gh<_i53.GetMessagesBloc>(),
        ));
    gh.factory<_i64.ReplyCommentListBloc>(
        () => _i64.ReplyCommentListBloc(gh<_i37.ICommentRepository>()));
    gh.factory<_i65.CommentLikesBloc>(
        () => _i65.CommentLikesBloc(gh<_i37.ICommentRepository>()));
    gh.factory<_i66.CommentListBloc>(
        () => _i66.CommentListBloc(gh<_i37.ICommentRepository>()));
    gh.factory<_i67.PostListBloc>(() => _i67.PostListBloc(
          gh<_i41.IPostRepository>(),
          gh<_i18.MyProfileInfoBloc>(),
          gh<_i62.MyPostListBloc>(),
        ));
    gh.factory<_i68.CommunityCreateBloc>(() => _i68.CommunityCreateBloc(
          gh<_i43.ICommunityRepository>(),
          gh<_i15.IAuthFacade>(),
          gh<_i58.MyCommunityListBloc>(),
          gh<_i51.CommunityListBloc>(),
        ));
    gh.factory<_i69.SendMessageBloc>(() => _i69.SendMessageBloc(
          gh<_i22.IChatRepository>(),
          gh<_i53.GetMessagesBloc>(),
          gh<_i15.IAuthFacade>(),
        ));
    gh.factory<_i70.CommentCreateBloc>(() => _i70.CommentCreateBloc(
          gh<_i37.ICommentRepository>(),
          gh<_i12.IAuthFacade>(),
          gh<_i66.CommentListBloc>(),
        ));
    gh.factory<_i71.AddReplyCommentBloc>(() => _i71.AddReplyCommentBloc(
          gh<_i37.ICommentRepository>(),
          gh<_i12.IAuthFacade>(),
          gh<_i67.PostListBloc>(),
          gh<_i64.ReplyCommentListBloc>(),
