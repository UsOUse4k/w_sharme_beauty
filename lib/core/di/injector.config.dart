...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i53.ICommunityRepository>(
        () => _i54.FirestoreCommunityRepository(
              gh<_i4.FirebaseFirestore>(),
              gh<_i3.FirebaseAuth>(),
              gh<_i5.FirebaseStorage>(),
            ));
    gh.factory<_i55.QuestionBloc>(() => _i55.QuestionBloc(
          gh<_i30.AddQuestionRepository>(),
          gh<_i16.IAuthFacade>(),
        ));
    gh.factory<_i56.RegisterWithEmailUC>(
        () => _i56.RegisterWithEmailUC(repository: gh<_i13.IAuthFacade>()));
    gh.factory<_i57.LoginWithEmailUC>(
        () => _i57.LoginWithEmailUC(repository: gh<_i13.IAuthFacade>()));
    gh.lazySingleton<_i58.IProfileInfoRepository>(
        () => _i59.FirebaseProfileFacade(
              gh<_i4.FirebaseFirestore>(),
              gh<_i3.FirebaseAuth>(),
              gh<_i5.FirebaseStorage>(),
            ));
    gh.factory<_i60.CommunityDetailBloc>(
        () => _i60.CommunityDetailBloc(gh<_i53.ICommunityRepository>()));
    gh.factory<_i61.UpdateCommunityBloc>(
        () => _i61.UpdateCommunityBloc(gh<_i53.ICommunityRepository>()));
    gh.factory<_i62.CommunityPostListBloc>(
        () => _i62.CommunityPostListBloc(gh<_i34.ICommunityPostRepository>()));
    gh.factory<_i63.ProfileInfoUpdateBloc>(() => _i63.ProfileInfoUpdateBloc(
          gh<_i58.IProfileInfoRepository>(),
          gh<_i13.IAuthFacade>(),
        ));
    gh.factory<_i64.CommunityListBloc>(
        () => _i64.CommunityListBloc(gh<_i53.ICommunityRepository>()));
    gh.factory<_i65.GetAllChatsUseCase>(
        () => _i65.GetAllChatsUseCase(gh<_i25.IChatRepository>()));
    gh.factory<_i66.GetMessagesBloc>(
        () => _i66.GetMessagesBloc(gh<_i25.IChatRepository>()));
    gh.factory<_i67.GetAllChatsBloc>(
        () => _i67.GetAllChatsBloc(gh<_i25.IChatRepository>()));
    gh.factory<_i68.SeenMessageBloc>(
        () => _i68.SeenMessageBloc(gh<_i25.IChatRepository>()));
    ...
    gh.factory<_i71.MyCommunityListBloc>(() => _i71.MyCommunityListBloc(
          gh<_i53.ICommunityRepository>(),
          gh<_i16.IAuthFacade>(),
        ));
    gh.factory<_i72.PostUserListBloc>(
        () => _i72.PostUserListBloc(gh<_i32.IPostRepository>()));
    ...
    gh.factory<_i77.CommunityCommentListBloc>(() =>
        _i77.CommunityCommentListBloc(gh<_i51.ICommunityCommentRepository>()));
    gh.factory<_i78.CommunityCommentLikesBloc>(() =>
        _i78.CommunityCommentLikesBloc(gh<_i51.ICommunityCommentRepository>()));
    ...
    gh.factory<_i80.ReplyCommentListBloc>(
        () => _i80.ReplyCommentListBloc(gh<_i44.ICommentRepository>()));
    gh.factory<_i81.CommentLikesBloc>(
        () => _i81.CommentLikesBloc(gh<_i44.ICommentRepository>()));
    gh.factory<_i82.CommentListBloc>(
        () => _i82.CommentListBloc(gh<_i44.ICommentRepository>()));
    ...
    gh.factory<_i84.GetAllQuestionBloc>(
        () => _i84.GetAllQuestionBloc(gh<_i46.IQuestionRepository>()));
