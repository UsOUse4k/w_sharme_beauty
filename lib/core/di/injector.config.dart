...
import 'package:w_sharme_beauty/features/question/presentation/bloc/add_question_bloc/question_bloc.dart'
    as _i7;
import 'package:w_sharme_beauty/firebase_module.dart' as _i36;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i22.RegisterWithEmailUC>(
        () => _i22.RegisterWithEmailUC(repository: gh<_i8.IAuthFacade>()));
    gh.factory<_i23.LoginWithEmailUC>(
        () => _i23.LoginWithEmailUC(repository: gh<_i8.IAuthFacade>()));
    ...
    gh.factory<_i27.CommunityListBloc>(
        () => _i27.CommunityListBloc(gh<_i20.ICommunityRepository>()));
    ...
    gh.factory<_i30.PostLikeBloc>(
        () => _i30.PostLikeBloc(gh<_i24.IPostRepository>()));
    ...
    gh.factory<_i33.PostDetailBloc>(() => _i33.PostDetailBloc(
          gh<_i24.IPostRepository>(),
          gh<_i11.IAuthFacade>(),
        ));
    ...
    gh.factory<_i35.CommunityCreateBloc>(() => _i35.CommunityCreateBloc(
          gh<_i20.ICommunityRepository>(),
          gh<_i11.IAuthFacade>(),
