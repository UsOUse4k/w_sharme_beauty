...
import 'package:w_sharme_beauty/features/question/presentation/bloc/get_all_question_bloc/get_all_question_bloc.dart'
    as _i97;
import 'package:w_sharme_beauty/firebase_module.dart' as _i104;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i55.IQuestionRepository>(
        () => _i56.FirestoreAddQuestionRepository(
    ...
    gh.lazySingleton<_i62.AddQuestionRepository>(
        () => _i63.FirestoreAddQuestionRepository(
              gh<_i16.IAuthFacade>(),
              firestore: gh<_i4.FirebaseFirestore>(),
              auth: gh<_i3.FirebaseAuth>(),
            ));
    ...
    gh.factory<_i66.AddQuestionBloc>(() => _i66.AddQuestionBloc(
          gh<_i62.AddQuestionRepository>(),
          gh<_i19.IAuthFacade>(),
        ));
    ...
    gh.factory<_i71.CommunityDetailBloc>(
        () => _i71.CommunityDetailBloc(gh<_i64.ICommunityRepository>()));
    gh.factory<_i72.UpdateCommunityBloc>(
        () => _i72.UpdateCommunityBloc(gh<_i64.ICommunityRepository>()));
    gh.factory<_i73.SubscribeCommunityBloc>(
        () => _i73.SubscribeCommunityBloc(gh<_i64.ICommunityRepository>()));
    gh.factory<_i74.CommunityPostListBloc>(
        () => _i74.CommunityPostListBloc(gh<_i40.ICommunityPostRepository>()));
    gh.factory<_i75.ProfileInfoUpdateBloc>(() => _i75.ProfileInfoUpdateBloc(
          gh<_i69.IProfileInfoRepository>(),
          gh<_i16.IAuthFacade>(),
        ));
    gh.factory<_i76.GetAllChatsUseCase>(
        () => _i76.GetAllChatsUseCase(gh<_i33.IChatRepository>()));
    gh.factory<_i77.GetMessagesBloc>(
        () => _i77.GetMessagesBloc(gh<_i33.IChatRepository>()));
    gh.factory<_i78.GetAllChatsBloc>(
        () => _i78.GetAllChatsBloc(gh<_i33.IChatRepository>()));
    gh.factory<_i79.SeenMessageBloc>(
        () => _i79.SeenMessageBloc(gh<_i33.IChatRepository>()));
    gh.factory<_i80.CommunityProfileInfoBloc>(
        () => _i80.CommunityProfileInfoBloc(
              gh<_i19.IAuthFacade>(),
              gh<_i69.IProfileInfoRepository>(),
            ));
    gh.factory<_i81.PostLikeBloc>(() => _i81.PostLikeBloc(
          gh<_i51.IPostRepository>(),
          gh<_i16.IAuthFacade>(),
        ));
    gh.factory<_i82.CommunityPostDetailBloc>(() =>
        _i82.CommunityPostDetailBloc(gh<_i83.ICommunityPostRepository>()));
    gh.factory<_i84.MyCommunityListBloc>(() => _i84.MyCommunityListBloc(
          gh<_i64.ICommunityRepository>(),
          gh<_i19.IAuthFacade>(),
        ));
    gh.factory<_i85.PostUserListBloc>(
        () => _i85.PostUserListBloc(gh<_i38.IPostRepository>()));
    gh.factory<_i86.CommunityCreateBloc>(() => _i86.CommunityCreateBloc(
          gh<_i64.ICommunityRepository>(),
          gh<_i19.IAuthFacade>(),
        ));
    gh.factory<_i87.PostDetailBloc>(() => _i87.PostDetailBloc(
          gh<_i51.IPostRepository>(),
          gh<_i19.IAuthFacade>(),
        ));
    gh.factory<_i88.MyPostListBloc>(() => _i88.MyPostListBloc(
          gh<_i51.IPostRepository>(),
          gh<_i19.IAuthFacade>(),
        ));
    gh.factory<_i89.UpdateNewEmailBloc>(
        () => _i89.UpdateNewEmailBloc(gh<_i69.IProfileInfoRepository>()));
    gh.factory<_i90.CommunityReplyCommentListBloc>(() =>
        _i90.CommunityReplyCommentListBloc(
            gh<_i59.ICommunityCommentRepository>()));
    gh.factory<_i91.CommunityCommentListBloc>(() =>
        _i91.CommunityCommentListBloc(gh<_i59.ICommunityCommentRepository>()));
    gh.factory<_i92.CommunityCommentLikesBloc>(() =>
        _i92.CommunityCommentLikesBloc(gh<_i59.ICommunityCommentRepository>()));
    gh.factory<_i93.AddReplyCommentBloc>(() => _i93.AddReplyCommentBloc(
          gh<_i52.ICommentRepository>(),
          gh<_i16.IAuthFacade>(),
          gh<_i7.ParentCommentIdBloc>(),
        ));
    gh.factory<_i94.ReplyCommentListBloc>(
        () => _i94.ReplyCommentListBloc(gh<_i52.ICommentRepository>()));
    gh.factory<_i95.CommentLikesBloc>(
        () => _i95.CommentLikesBloc(gh<_i52.ICommentRepository>()));
    gh.factory<_i96.CommentListBloc>(
        () => _i96.CommentListBloc(gh<_i52.ICommentRepository>()));
    gh.factory<_i97.GetAllQuestionBloc>(
        () => _i97.GetAllQuestionBloc(gh<_i55.IQuestionRepository>()));
    gh.factory<_i98.CommunityAddReplyCommentBloc>(
        () => _i98.CommunityAddReplyCommentBloc(
              gh<_i59.ICommunityCommentRepository>(),
              gh<_i19.IAuthFacade>(),
              gh<_i7.ParentCommentIdBloc>(),
            ));
    gh.factory<_i99.CommunityListBloc>(
        () => _i99.CommunityListBloc(gh<_i64.ICommunityRepository>()));
    gh.factory<_i100.PostListBloc>(() => _i100.PostListBloc(
          gh<_i51.IPostRepository>(),
          gh<_i88.MyPostListBloc>(),
        ));
    gh.factory<_i101.SendMessageBloc>(() => _i101.SendMessageBloc(
          gh<_i33.IChatRepository>(),
          gh<_i77.GetMessagesBloc>(),
          gh<_i19.IAuthFacade>(),
        ));
    gh.factory<_i102.CreateChatroomBloc>(() => _i102.CreateChatroomBloc(
          gh<_i33.IChatRepository>(),
          gh<_i77.GetMessagesBloc>(),
          gh<_i19.IAuthFacade>(),
        ));
    gh.factory<_i103.CommunityCommentCreateBloc>(
        () => _i103.CommunityCommentCreateBloc(
              gh<_i59.ICommunityCommentRepository>(),
              gh<_i19.IAuthFacade>(),
              gh<_i91.CommunityCommentListBloc>(),
            ));
    return this;
  }
}
