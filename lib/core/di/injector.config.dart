...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i18.MyProfileInfoBloc>(
        () => _i18.MyProfileInfoBloc(gh<_i19.IAuthFacade>()));
    gh.factory<_i20.LogoutUC>(
        () => _i20.LogoutUC(repository: gh<_i19.IAuthFacade>()));
    gh.lazySingleton<_i21.ICreateAdvartRepository>(
        () => _i22.FirebaseCreateAdvartRepository(
              gh<_i3.FirebaseAuth>(),
              gh<_i4.FirebaseFirestore>(),
              gh<_i5.FirebaseStorage>(),
            ));
    gh.factory<_i23.CreateAdvertBloc>(() => _i23.CreateAdvertBloc(
          gh<_i21.ICreateAdvartRepository>(),
          gh<_i19.IAuthFacade>(),
        ));
    gh.lazySingleton<_i24.ICategoryRepository>(
        () => _i25.FirebaseCategoryFacade(gh<_i4.FirebaseFirestore>()));
    gh.factory<_i26.CategoryBloc>(
        () => _i26.CategoryBloc(gh<_i24.ICategoryRepository>()));
    gh.factory<_i27.GetAllUsersBloc>(
        () => _i27.GetAllUsersBloc(gh<_i19.IAuthFacade>()));
    gh.factory<_i28.UpdateStatusUserBloc>(
        () => _i28.UpdateStatusUserBloc(gh<_i19.IAuthFacade>()));
