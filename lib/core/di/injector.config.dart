...
import 'package:w_sharme_beauty/features/question/presentation/bloc/get_all_question_bloc/get_all_question_bloc.dart'
    as _i92;
import 'package:w_sharme_beauty/firebase_module.dart' as _i99;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i16.LogoutUC>(
        () => _i16.LogoutUC(repository: gh<_i17.IAuthFacade>()));
    gh.lazySingleton<_i18.ICreateAdvartRepository>(
        () => _i19.FirebaseCreateAdvartRepository(
              gh<_i3.FirebaseAuth>(),
              gh<_i4.FirebaseFirestore>(),
              gh<_i5.FirebaseStorage>(),
            ));
    gh.factory<_i20.CreateAdvertBloc>(() => _i20.CreateAdvertBloc(
          gh<_i18.ICreateAdvartRepository>(),
          gh<_i17.IAuthFacade>(),
        ));
    gh.lazySingleton<_i21.ICategoryRepository>(
        () => _i22.FirebaseCategoryFacade(gh<_i4.FirebaseFirestore>()));
    gh.factory<_i23.CategoryBloc>(
        () => _i23.CategoryBloc(gh<_i21.ICategoryRepository>()));
    gh.factory<_i24.GetAllUsersBloc>(
        () => _i24.GetAllUsersBloc(gh<_i17.IAuthFacade>()));
    gh.factory<_i25.UpdateStatusUserBloc>(
        () => _i25.UpdateStatusUserBloc(gh<_i17.IAuthFacade>()));
    gh.factory<_i26.MyProfileInfoBloc>(
        () => _i26.MyProfileInfoBloc(gh<_i17.IAuthFacade>()));
    gh.factory<_i27.UserDetailBloc>(
        () => _i27.UserDetailBloc(gh<_i17.IAuthFacade>()));
    gh.factory<_i28.SubscribeBloc>(
        () => _i28.SubscribeBloc(gh<_i17.IAuthFacade>()));
    ...
    gh.factory<_i40.AuthBloc>(() => _i40.AuthBloc(gh<_i17.IAuthFacade>()));
    ...
    gh.lazySingleton<_i59.AddQuestionRepository>(
        () => _i60.FirestoreAddQuestionRepository(
              gh<_i14.IAuthFacade>(),
              firestore: gh<_i4.FirebaseFirestore>(),
              auth: gh<_i3.FirebaseAuth>(),
            ));
    ...
    gh.factory<_i63.AddQuestionBloc>(() => _i63.AddQuestionBloc(
          gh<_i59.AddQuestionRepository>(),
          gh<_i17.IAuthFacade>(),
        ));
    gh.factory<_i64.RegisterWithEmailUC>(
        () => _i64.RegisterWithEmailUC(repository: gh<_i14.IAuthFacade>()));
    gh.factory<_i65.LoginWithEmailUC>(
        () => _i65.LoginWithEmailUC(repository: gh<_i14.IAuthFacade>()));
    ...
    gh.factory<_i68.CommunityDetailBloc>(
        () => _i68.CommunityDetailBloc(gh<_i61.ICommunityRepository>()));
    gh.factory<_i69.UpdateCommunityBloc>(
        () => _i69.UpdateCommunityBloc(gh<_i61.ICommunityRepository>()));
    gh.factory<_i70.SubscribeCommunityBloc>(
        () => _i70.SubscribeCommunityBloc(gh<_i61.ICommunityRepository>()));
    gh.factory<_i71.CommunityPostListBloc>(
        () => _i71.CommunityPostListBloc(gh<_i38.ICommunityPostRepository>()));
    gh.factory<_i72.ProfileInfoUpdateBloc>(() => _i72.ProfileInfoUpdateBloc(
          gh<_i66.IProfileInfoRepository>(),
          gh<_i14.IAuthFacade>(),
        ));
    gh.factory<_i73.CommunityListBloc>(
        () => _i73.CommunityListBloc(gh<_i61.ICommunityRepository>()));
    gh.factory<_i74.GetAllChatsUseCase>(
        () => _i74.GetAllChatsUseCase(gh<_i31.IChatRepository>()));
    gh.factory<_i75.GetMessagesBloc>(
        () => _i75.GetMessagesBloc(gh<_i31.IChatRepository>()));
    gh.factory<_i76.GetAllChatsBloc>(
        () => _i76.GetAllChatsBloc(gh<_i31.IChatRepository>()));
    gh.factory<_i77.SeenMessageBloc>(
        () => _i77.SeenMessageBloc(gh<_i31.IChatRepository>()));
    ...
    gh.factory<_i80.MyCommunityListBloc>(() => _i80.MyCommunityListBloc(
          gh<_i61.ICommunityRepository>(),
          gh<_i17.IAuthFacade>(),
        ));
    gh.factory<_i81.PostUserListBloc>(
        () => _i81.PostUserListBloc(gh<_i36.IPostRepository>()));
    gh.factory<_i82.CommunityCreateBloc>(() => _i82.CommunityCreateBloc(
          gh<_i61.ICommunityRepository>(),
          gh<_i17.IAuthFacade>(),
        ));
    gh.factory<_i83.PostDetailBloc>(() => _i83.PostDetailBloc(
          gh<_i49.IPostRepository>(),
          gh<_i17.IAuthFacade>(),
        ));
    gh.factory<_i84.MyPostListBloc>(() => _i84.MyPostListBloc(
          gh<_i49.IPostRepository>(),
          gh<_i17.IAuthFacade>(),
        ));
    gh.factory<_i85.CommunityReplyCommentListBloc>(() =>
        _i85.CommunityReplyCommentListBloc(
            gh<_i57.ICommunityCommentRepository>()));
    gh.factory<_i86.CommunityCommentListBloc>(() =>
        _i86.CommunityCommentListBloc(gh<_i57.ICommunityCommentRepository>()));
    gh.factory<_i87.CommunityCommentLikesBloc>(() =>
        _i87.CommunityCommentLikesBloc(gh<_i57.ICommunityCommentRepository>()));
    gh.factory<_i88.CommunityAddReplyCommentBloc>(
        () => _i88.CommunityAddReplyCommentBloc(
              gh<_i57.ICommunityCommentRepository>(),
              gh<_i17.IAuthFacade>(),
              gh<_i85.CommunityReplyCommentListBloc>(),
              gh<_i7.ParentCommentIdBloc>(),
            ));
    gh.factory<_i89.ReplyCommentListBloc>(
        () => _i89.ReplyCommentListBloc(gh<_i50.ICommentRepository>()));
    gh.factory<_i90.CommentLikesBloc>(
        () => _i90.CommentLikesBloc(gh<_i50.ICommentRepository>()));
    gh.factory<_i91.CommentListBloc>(
        () => _i91.CommentListBloc(gh<_i50.ICommentRepository>()));
    gh.factory<_i92.GetAllQuestionBloc>(
        () => _i92.GetAllQuestionBloc(gh<_i53.IQuestionRepository>()));
    gh.factory<_i93.PostListBloc>(() => _i93.PostListBloc(
          gh<_i49.IPostRepository>(),
          gh<_i84.MyPostListBloc>(),
        ));
    gh.factory<_i94.SendMessageBloc>(() => _i94.SendMessageBloc(
          gh<_i31.IChatRepository>(),
          gh<_i75.GetMessagesBloc>(),
          gh<_i17.IAuthFacade>(),
        ));
    gh.factory<_i95.CreateChatroomBloc>(() => _i95.CreateChatroomBloc(
          gh<_i31.IChatRepository>(),
          gh<_i75.GetMessagesBloc>(),
          gh<_i17.IAuthFacade>(),
        ));
    gh.factory<_i96.CommentCreateBloc>(() => _i96.CommentCreateBloc(
          gh<_i50.ICommentRepository>(),
          gh<_i14.IAuthFacade>(),
          gh<_i91.CommentListBloc>(),
        ));
    gh.factory<_i97.CommunityCommentCreateBloc>(
        () => _i97.CommunityCommentCreateBloc(
              gh<_i57.ICommunityCommentRepository>(),
              gh<_i17.IAuthFacade>(),
              gh<_i86.CommunityCommentListBloc>(),
            ));
    gh.factory<_i98.AddReplyCommentBloc>(() => _i98.AddReplyCommentBloc(
          gh<_i50.ICommentRepository>(),
          gh<_i14.IAuthFacade>(),
          gh<_i93.PostListBloc>(),
          gh<_i89.ReplyCommentListBloc>(),
          gh<_i7.ParentCommentIdBloc>(),
        ));
    return this;
  }
