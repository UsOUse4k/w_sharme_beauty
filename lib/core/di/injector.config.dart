...
import 'package:w_sharme_beauty/features/question/presentation/bloc/add_question_bloc/question_bloc.dart'
    as _i12;
import 'package:w_sharme_beauty/firebase_module.dart' as _i79;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i22.UnsubscribeBloc>(
        () => _i22.UnsubscribeBloc(gh<_i16.IAuthFacade>()));
    gh.lazySingleton<_i23.IChatGroupRepository>(
        () => _i24.FirebaseChatGroupFacade(
              gh<_i3.FirebaseAuth>(),
              gh<_i4.FirebaseFirestore>(),
              gh<_i5.FirebaseStorage>(),
            ));
    gh.lazySingleton<_i25.IChatRepository>(() => _i26.FirebaseChatFacade(
          gh<_i3.FirebaseAuth>(),
          gh<_i4.FirebaseFirestore>(),
          gh<_i5.FirebaseStorage>(),
        ));
    gh.factory<_i27.SendMessageGroupBloc>(() => _i27.SendMessageGroupBloc(
          gh<_i23.IChatGroupRepository>(),
          gh<_i16.IAuthFacade>(),
        ));
    gh.factory<_i28.GetGroupBloc>(() => _i28.GetGroupBloc(
          gh<_i23.IChatGroupRepository>(),
          gh<_i16.IAuthFacade>(),
        ));
    gh.factory<_i29.GetAllAdminsChatGroupBloc>(
        () => _i29.GetAllAdminsChatGroupBloc(
              gh<_i23.IChatGroupRepository>(),
              gh<_i16.IAuthFacade>(),
            ));
    gh.lazySingleton<_i30.IPostRepository>(() => _i31.FirestorePostRepository(
          gh<_i4.FirebaseFirestore>(),
          gh<_i3.FirebaseAuth>(),
          gh<_i5.FirebaseStorage>(),
        ));
    gh.lazySingleton<_i32.AddQuestionRepository>(
        () => _i33.FirestoreAddQuestionRepository(
    ...
    gh.factory<_i37.GetAllChatGroupBloc>(
        () => _i37.GetAllChatGroupBloc(gh<_i23.IChatGroupRepository>()));
    gh.factory<_i38.RemoveAdminChatGroupBloc>(
        () => _i38.RemoveAdminChatGroupBloc(gh<_i23.IChatGroupRepository>()));
    gh.factory<_i39.UpdateChatGroupBloc>(
        () => _i39.UpdateChatGroupBloc(gh<_i23.IChatGroupRepository>()));
    gh.factory<_i40.CreateChatGroupBloc>(
        () => _i40.CreateChatGroupBloc(gh<_i23.IChatGroupRepository>()));
    gh.factory<_i41.InviteUsersChatGroupBloc>(
        () => _i41.InviteUsersChatGroupBloc(gh<_i23.IChatGroupRepository>()));
    gh.factory<_i42.UpdateManagerChatGroupBloc>(
        () => _i42.UpdateManagerChatGroupBloc(gh<_i23.IChatGroupRepository>()));
    gh.factory<_i43.GetAllGroupMessagesBloc>(
        () => _i43.GetAllGroupMessagesBloc(gh<_i23.IChatGroupRepository>()));
    gh.lazySingleton<_i44.ICommentRepository>(() => _i45.FirebaseCommentFacade(
          gh<_i4.FirebaseFirestore>(),
          gh<_i3.FirebaseAuth>(),
        ));
    gh.factory<_i46.PostCreateBloc>(() => _i46.PostCreateBloc(
          gh<_i47.IPostRepository>(),
          gh<_i16.IAuthFacade>(),
        ));
    gh.factory<_i48.CommunityCreatePostBloc>(() => _i48.CommunityCreatePostBloc(
          gh<_i34.ICommunityPostRepository>(),
          gh<_i16.IAuthFacade>(),
        ));
    gh.lazySingleton<_i49.ICommunityRepository>(
        () => _i50.FirestoreCommunityRepository(
              gh<_i4.FirebaseFirestore>(),
              gh<_i3.FirebaseAuth>(),
              gh<_i5.FirebaseStorage>(),
            ));
    gh.factory<_i51.RegisterWithEmailUC>(
        () => _i51.RegisterWithEmailUC(repository: gh<_i13.IAuthFacade>()));
    gh.factory<_i52.LoginWithEmailUC>(
        () => _i52.LoginWithEmailUC(repository: gh<_i13.IAuthFacade>()));
    gh.lazySingleton<_i53.IProfileInfoRepository>(
        () => _i54.FirebaseProfileFacade(
              gh<_i4.FirebaseFirestore>(),
              gh<_i3.FirebaseAuth>(),
              gh<_i5.FirebaseStorage>(),
            ));
    gh.factory<_i55.CommunityDetailBloc>(
        () => _i55.CommunityDetailBloc(gh<_i49.ICommunityRepository>()));
    gh.factory<_i56.UpdateCommunityBloc>(
        () => _i56.UpdateCommunityBloc(gh<_i49.ICommunityRepository>()));
    gh.factory<_i57.CommunityPostListBloc>(
        () => _i57.CommunityPostListBloc(gh<_i34.ICommunityPostRepository>()));
    gh.factory<_i58.ProfileInfoUpdateBloc>(() => _i58.ProfileInfoUpdateBloc(
          gh<_i53.IProfileInfoRepository>(),
          gh<_i13.IAuthFacade>(),
        ));
    gh.factory<_i59.CommunityListBloc>(
        () => _i59.CommunityListBloc(gh<_i49.ICommunityRepository>()));
    gh.factory<_i60.GetAllChatsUseCase>(
        () => _i60.GetAllChatsUseCase(gh<_i25.IChatRepository>()));
    gh.factory<_i61.GetMessagesBloc>(
        () => _i61.GetMessagesBloc(gh<_i25.IChatRepository>()));
    gh.factory<_i62.GetAllChatsBloc>(
        () => _i62.GetAllChatsBloc(gh<_i25.IChatRepository>()));
    gh.factory<_i63.SeenMessageBloc>(
        () => _i63.SeenMessageBloc(gh<_i25.IChatRepository>()));
    gh.factory<_i64.CommunityProfileInfoBloc>(
        () => _i64.CommunityProfileInfoBloc(
              gh<_i16.IAuthFacade>(),
              gh<_i53.IProfileInfoRepository>(),
            ));
    gh.factory<_i65.PostLikeBloc>(() => _i65.PostLikeBloc(
          gh<_i47.IPostRepository>(),
          gh<_i13.IAuthFacade>(),
        ));
    gh.factory<_i66.MyCommunityListBloc>(() => _i66.MyCommunityListBloc(
          gh<_i49.ICommunityRepository>(),
          gh<_i16.IAuthFacade>(),
        ));
    gh.factory<_i67.PostUserListBloc>(
        () => _i67.PostUserListBloc(gh<_i30.IPostRepository>()));
    gh.factory<_i68.CommunityCreateBloc>(() => _i68.CommunityCreateBloc(
          gh<_i49.ICommunityRepository>(),
          gh<_i16.IAuthFacade>(),
        ));
    gh.factory<_i69.PostDetailBloc>(() => _i69.PostDetailBloc(
          gh<_i47.IPostRepository>(),
          gh<_i16.IAuthFacade>(),
        ));
    gh.factory<_i70.MyPostListBloc>(() => _i70.MyPostListBloc(
          gh<_i47.IPostRepository>(),
          gh<_i16.IAuthFacade>(),
        ));
    gh.factory<_i71.CreateChatroomBloc>(() => _i71.CreateChatroomBloc(
          gh<_i25.IChatRepository>(),
          gh<_i61.GetMessagesBloc>(),
        ));
    gh.factory<_i72.ReplyCommentListBloc>(
        () => _i72.ReplyCommentListBloc(gh<_i44.ICommentRepository>()));
    gh.factory<_i73.CommentLikesBloc>(
        () => _i73.CommentLikesBloc(gh<_i44.ICommentRepository>()));
    gh.factory<_i74.CommentListBloc>(
        () => _i74.CommentListBloc(gh<_i44.ICommentRepository>()));
    gh.factory<_i75.PostListBloc>(() => _i75.PostListBloc(
          gh<_i47.IPostRepository>(),
          gh<_i19.MyProfileInfoBloc>(),
          gh<_i70.MyPostListBloc>(),
        ));
    gh.factory<_i76.SendMessageBloc>(() => _i76.SendMessageBloc(
          gh<_i25.IChatRepository>(),
          gh<_i61.GetMessagesBloc>(),
          gh<_i16.IAuthFacade>(),
        ));
    gh.factory<_i77.CommentCreateBloc>(() => _i77.CommentCreateBloc(
          ...
          gh<_i13.IAuthFacade>(),
          gh<_i74.CommentListBloc>(),
        ));
    gh.factory<_i78.AddReplyCommentBloc>(() => _i78.AddReplyCommentBloc(
          gh<_i44.ICommentRepository>(),
          gh<_i13.IAuthFacade>(),
          gh<_i75.PostListBloc>(),
          gh<_i72.ReplyCommentListBloc>(),
