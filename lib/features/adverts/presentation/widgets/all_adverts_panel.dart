...
class AllAdvertsPanel extends StatefulWidget {
  const AllAdvertsPanel({
    super.key,
    this.onCloseTap,
  });
  ...
  @override
  State<AllAdvertsPanel> createState() => _AllAdvertsPanelState();
}

class _AllAdvertsPanelState extends State<AllAdvertsPanel> {
  @override
  void initState() {
    super.initState();

    context.read<AdvertsCubit>().getAdverts();
  }
