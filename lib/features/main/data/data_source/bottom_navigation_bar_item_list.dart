...
List<BottomNavigationBarItemModel> items = [
  ...
  BottomNavigationBarItemModel(
    image: Image.asset('assets/icons/activeAnnouncement.png/', width: 18, height: 18),
    activeImage: Image.asset('assets/icons/activeAnnouncement.png/', width: 18, height: 18),
    text: 'Вопрос',
  ),
  BottomNavigationBarItemModel(
