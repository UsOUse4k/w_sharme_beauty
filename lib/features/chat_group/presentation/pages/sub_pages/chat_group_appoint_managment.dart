...
class ChatGroupAppointManagment extends StatefulWidget {
  const ChatGroupAppointManagment({
    super.key,
  ...
  @override
  State<ChatGroupAppointManagment> createState() =>
      _ChatGroupAppointManagmentState();
}

class _ChatGroupAppointManagmentState extends State<ChatGroupAppointManagment> {
  @override
  void initState() {
    context
        .read<UserDetailBloc>()
